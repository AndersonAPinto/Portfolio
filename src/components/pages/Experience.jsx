        ...
        <div className="container__Experience">
            ...
            <div>
                <div className="imgs_site" >
                    ...
                    <img src={App_1} style={{ width: '25%', height: '450px', marginLeft: '10vw', borderRadius: '10px' }} alt="Foto da Aplicação"/>
                </div>
            </div>
            <hr style={{ margin: '25px', width: '70vw' }} />
            <div>
                <div className="imgs_site" >
                    <img src={SiteGadj} style={{ width: '50%', height: '250px', marginRight: '15px', borderRadius: '10px' }} alt="Foto da Aplicação"/>
            ...
            <div>
                <div className="imgs_site" >
                    ...
                    <img src={WebSite_Englistest} style={{ width: '50%', height: '250px', marginLeft: '15px', borderRadius: '10px' }} alt="Foto da Aplicação"/>
                </div>
            </div>
            <hr style={{ margin: '25px', width: '70vw' }} />
            <div >
                <div className="imgs_site" >
                    <img src={WebSiteCOnsEletr} style={{ width: '50%', height: '250px', marginRight: '15px', borderRadius: '10px' }} alt="Foto da Aplicação"/>
                    <p style={{ fontSize: '1.3em', marginRight:'1vw' }}>
