        ...
        <div className="containerPages">
            ...
            <div className="iconstech">
                <div className="aligntextbtns">
                    <div className="tess"><i class="fa-brands fa-html5" style={{ fontSize: '100px', color: '#003049' }}></i></div>
                    ...
                    <div className="tess"><i class="fa-brands fa-css3-alt" style={{ fontSize: '100px', color: '#003049' }}></i></div>
            ...
            <div className="iconstech_">
                <div  className="aligntextbtns">
                    <div className="tess"><i class="fa-brands fa-square-js" style={{ fontSize: '100px', color: '#003049' }}></i></div>
                    ...
                    <div className="tess"><i class="fa-brands fa-react" style={{ fontSize: '100px', color: '#003049' }}></i></div>
